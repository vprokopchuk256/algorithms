...
RSpec.describe Algorithms::Graph::LazyPrimMST do
  ...
  context 'with one edge' do
    let(:edge2) { Algorithms::DataStructures::Graphs::Edge.new(0, 4, 2) }
